...
public class T08_AlertTest extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		alertError.setContentText("ERROR창 입니다.");
		alertError.showAndWait(); 	//Alert창 보이기
		//===========================================================
		Alert alertWarn = new Alert(AlertType.WARNING);
		alertWarn.setTitle("WARNING");
		alertWarn.setContentText("WARNING창 입니다.");
		alertWarn.showAndWait(); 	//Alert창 보이기
		//===========================================================
		Alert alertConfirm = new Alert(AlertType.CONFIRMATION);
		alertConfirm.setTitle("CONFIRMATION");
		alertConfirm.setContentText("CONFIRMATION창 입니다.");
		...
		inputDialog.setHeaderText("TextInpuptDialog창입니다."); 	//출력메세지
		
		//창을 보이고 입력한 값을 일겅오기
		Optional<String> result = inputDialog.showAndWait();
		String strResult = null; 	//입력한 값이 저장될 변수 선언
		
		//입력한 값이 있는지 검사(값 입력 후 OK버튼 눌렀는지 검사)
		if(result.isPresent()) {

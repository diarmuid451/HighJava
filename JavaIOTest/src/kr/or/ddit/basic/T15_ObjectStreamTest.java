...
public class T15_ObjectStreamTest {
	...
	public static void main(String[] args) {
		...
		Member mem2 = new Member("홍길북", 30, "대흥");
		Member mem3 = new Member("홍길남", 40, "대방");
		Member mem4 = new Member("홍길서", 44, "대구");
...
class Member implements Serializable {
	//자바는 Serializable인터페이스를 구현한 클래스만 직렬화 할 수 있도록 제한하고 있다.
	//구현 안하면 직렬화 작업시 java.io.NotSerializableException 예외가 발생한다.
	
	//transient >>  직렬화가 되지 않을 경우 멤버변수에 저장한다. (static 필드도 직렬화가 되지 않는다.)

...
public class T05_MemberInfoTest {
	...
	private void deleteMember() throws SQLException {
		...
		String memId = scan.next();
			...
			if(cnt > 0) {
				...
				System.out.println(memId + "회원삭제실패");
			}
	 ...
	 * 모든 회원을 출력하는 메서드
	 */
	private void displayMemberAll() throws SQLException {
		System.out.println("\r\n------------------------------------------");
		System.out.println("ID\t이름\t전화번호\t"+"\t주소");
			...
			while(rs.next()) {
				String memId = rs.getNString(1);
				String memName = rs.getNString(2);
				String memTel = rs.getNString(3);
				String memAddr = rs.getNString(4);
	 ...
	 * @return false : 신규회원
	 */
	private boolean getMember(String memId) throws SQLException {

 ...
 * annotation?
 * 
 * 프로그램 소스코드 안에 다른 프로그램을 위한 정보를 미리 약속된 형식으로 포함 시킨것(JDK1.5부터 지원)
 * 주석처럼 프로그래밍 언어에 영향을 미치지 않으면서도 다른 프로그램에게 유용한 정보를 제공한다.
 * 
 * 종류 :
 * 1. 표준애너테이션 : 주로 컴파일러에게 유용한 정보를 제공하기 위한 애너테이션
 ...
 * 
 * 애너테이션 요소의 규칙
 * 1. 요소의 타입은 기본형, String, enum, annotation, class만 적용된다.
 * 2. ()안에 매개변수를 선언할 수 없다.
 * 3. 예외를 선언할 수 없다.
...
@Target(ElementType.METHOD)		//annotation이 적용가능한 대상을 지정한다.

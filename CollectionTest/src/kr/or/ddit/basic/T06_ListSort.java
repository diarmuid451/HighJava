...
public class T06_ListSort {
	 ...
	 *  Comparator에서는 compara()메서드를 구현해야 한다.
	 */
	...
	public static void main(String[] args) {
		...
		//정렬방식을 번경하려면 정렬방식을 결정하는 객체를 만들어서 
...
class Desc implements Comparator<String> {
	...
	/*
	 * compare()메서드의 반환값을 결정하는 방법 >> 이 메서드가 양수를 반환하면 두값의 순서가 바꾸니다.
	 * 
	 * - 오름차순 정렬일 경우 >>앞의 값이 크면 양수, 같으면 0, 작으면 음수를 반환하도록 한다.
	 * 
	 * String 객체는 정렬을 위해서 compareTo()메서드가 구현되어 있는데  이 메서드의 반환값은  오름차순에 맞게 변환되도록 구현되어 있다.

...
public class FaceRecognition {
	...
	private static final String CLIENT_ID = "y_sFmqOoANdfiNBUgBvG";
	// 애플리케이션 클라이언트 시크릿값
	//private static final String CLIENT_SECRET = "60fJyesyCs";
	private static final String CLIENT_SECRET = "ApFMldZhG4";
...
//		String apiURL = "https://openapi.naver.com/v1/vision/face"; // 얼굴 감지
	...
	public void setFileTransfer() {
		...
		try {
			...
			String LINE_FEED = "\r\n";
			// file 추가
			String imgFile = FaceRecognition.class.getResource("0002719863_001_20180812083015442.jpg").getPath();

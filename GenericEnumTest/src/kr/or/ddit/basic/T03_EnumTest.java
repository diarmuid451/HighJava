 ...
 *  
 *  열거형 선언하는 방법 : enum 열거형이름 {상수1, 상수2,...상수n};
 *  enum Data {A,B,C,D};
 *  
 *  
 */
public class T03_EnumTest {
	...
	public enum Season{봄("3월부터 5월까지"), 여름("6월부터 8월까지"), 가을("9월부터 11월까지"), 겨울("12월부터 2월까지"); //,대구("테스트용");
		//괄호 속의 값이 저장될 변수 선언
		private String str;
	
		//상성자 만들기(열거형의 생성자는 제어자가 묵시적으로 private이다.
	...
	public static void main(String[] args) {
		 ...
		 *  3. valueOf("열거형상수이름");	: 지정된 열거형에서 열거형상수이름과 일치하는 열거형 상수를 반환한다.
		 */
		...
		// 얼거형 객체변수에 값 저장하기
		myCity2 = City.서울;
		myCity1 = City.valueOf("서울"); //City enum에서 서울인 객체변환
		...
		for (City city : City.values()) {
			System.out.print(city + " : " + city.ordinal()+ ",\t");
		}
...
//		System.out.println(city == Season.대구);  //같은 이름의 객체라도 enum타입이 다르다면 컴파일에러가 발생
